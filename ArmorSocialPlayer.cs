...
namespace ArmorSocial
{
    public class ArmorSocialPlayer : ModPlayer
    {
        ...
        public bool vortexStealthActive = false;
        public float beetleCounter = 0.0f;

        //This happens before the lunar armor vars gets reset to 0 because we aren't actually wearing the armor
        public override void PostUpdateBuffs()
        {
            base.PostUpdateBuffs();
            player.GetModPlayer<ArmorSocialPlayer>().solarCounter = player.solarCounter;
            player.GetModPlayer<ArmorSocialPlayer>().vortexStealthActive = player.vortexStealthActive;
            player.GetModPlayer<ArmorSocialPlayer>().beetleCounter = player.beetleCounter;
        }
        ...
        public void UpdateModArmorSets(Item head, Item body, Item legs)
        {
            ...
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = player.setBonus;
        ...
        public void UpdateArmorSets()
        {
            ...
            player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = "";
            
            if (vanityBody == 67 && vanityLegs == 56 && (vanityHead >= 103 && vanityHead <= 105))
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Shroomite");
            ...
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Wood");
                ++player.statDefense;
            }
            ...
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.MetalTier1");
            ...
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.MetalTier2");
                player.statDefense += 3;
            }
            if (vanityHead == 188 && vanityBody == 189 && vanityLegs == 129)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Fossil");
                player.thrownCost50 = true;
            }
            if (vanityHead == 50 && vanityBody == 31 && vanityLegs == 30)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Platinum");
                player.statDefense += 4;
            }
            if (vanityHead == 112 && vanityBody == 75 && vanityLegs == 64)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Pumpkin");
            ...
            if (vanityHead == 22 && vanityBody == 14 && vanityLegs == 14)
            {
                ...
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Ninja");
            }
            if (vanityHead == 157 && vanityBody == 105 && vanityLegs == 98)
            {
                player.beetleCounter = player.GetModPlayer<ArmorSocialPlayer>().beetleCounter;
                int num1 = 0;
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.BeetleDamage");
            ...
            {
                player.beetleCounter = player.GetModPlayer<ArmorSocialPlayer>().beetleCounter;
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.BeetleDefense");
            ...
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Wizard");
                player.magicCrit += 10;
            }
            if (vanityHead == 159 && (vanityBody >= 58 && vanityBody <= 63 || vanityBody == 167))
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.MagicHat");
                player.statManaMax2 += 60;
            }
            if ((vanityHead == 5 || vanityHead == 74) && (vanityBody == 5 || vanityBody == 48) && (vanityLegs == 5 || vanityLegs == 44))
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.ShadowScale");
                player.moveSpeed += 0.15f;
            }
            if (vanityHead == 57 && vanityBody == 37 && vanityLegs == 35)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Crimson");
                player.crimsonRegen = true;
            }
            if (vanityHead == 101 && vanityBody == 66 && vanityLegs == 55)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.SpectreHealing");
                player.ghostHeal = true;
                player.magicDamage -= .4f;
            }
            if (vanityHead == 156 && vanityBody == 66 && vanityLegs == 55)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.SpectreDamage");
                player.ghostHurt = true;
            }
            if (vanityHead == 6 && vanityBody == 6 && vanityLegs == 6)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Meteor");
                player.spaceGun = true;
            }
            if (vanityHead == 46 && vanityBody == 27 && vanityLegs == 26)
            {
                player.frostArmor = true;
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Frost");
                player.frostBurn = true;
            }
            if ((vanityHead == 75 || vanityHead == 7) && (vanityBody == 7 && vanityLegs == 7))
            {
                player.boneArmor = true;
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Bone");
                player.ammoCost80 = true;
            }
            if ((vanityHead == 76 || vanityHead == 8) && (vanityBody == 49 || vanityBody == 8) && (vanityLegs == 45 || vanityLegs == 8))
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Jungle");
                player.manaCost -= 0.16f;
            }
            if (vanityHead == 9 && vanityBody == 9 && vanityLegs == 9)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Molten");
                player.meleeDamage += 0.17f;
            }
            if (vanityHead == 11 && vanityBody == 20 && vanityLegs == 19)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Mining");
                player.pickSpeed -= 0.3f;
            }
            if ((vanityHead == 78 || vanityHead == 79 || vanityHead == 80) && (vanityBody == 51 && vanityLegs == 47))
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Chlorophyte");
                player.AddBuff(60, 18000, true);
            }
            if (vanityHead == 99 && vanityBody == 65 && vanityLegs == 54)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Turtle");
                player.thorns = 1f;
            ...
            if (vanityBody == 17 && vanityLegs == 16)
            {
                if (vanityHead == 29)
                {
                    player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.CobaltCaster");
                    player.manaCost -= 0.14f;
                }
                else if (vanityHead == 30)
                {
                    player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.CobaltMelee");
                    player.meleeSpeed += 0.15f;
                }
                else if (vanityHead == 31)
                {
                    player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.CobaltRanged");
                    player.ammoCost80 = true;
                }
            }
            if (vanityBody == 18 && vanityLegs == 17)
            {
                if (vanityHead == 32)
                {
                    player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.MythrilCaster");
                    player.manaCost -= 0.17f;
                }
                else if (vanityHead == 33)
                {
                    player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.MythrilMelee");
                    player.meleeCrit += 5;
                }
                else if (vanityHead == 34)
                {
                    player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.MythrilRanged");
                    player.ammoCost80 = true;
                }
            }
            if (vanityBody == 19 && vanityLegs == 18)
            {
                if (vanityHead == 35)
                {
                    player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.AdamantiteCaster");
                    player.manaCost -= 0.19f;
                }
                else if (vanityHead == 36)
                {
                    player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.AdamantiteMelee");
                    player.meleeSpeed += 0.18f;
                    player.moveSpeed += 0.18f;
                }
                else if (vanityHead == 37)
                {
                    player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.AdamantiteRanged");
                    player.ammoCost75 = true;
                }
            }
            if (vanityBody == 54 && vanityLegs == 49 && (vanityHead == 83 || vanityHead == 84 || vanityHead == 85))
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Palladium");
                player.onHitRegen = true;
            }
            if (vanityBody == 55 && vanityLegs == 50 && (vanityHead == 86 || vanityHead == 87 || vanityHead == 88))
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Orichalcum");
                player.onHitPetal = true;
            }
            if (vanityBody == 56 && vanityLegs == 51 && (vanityHead == 89 || vanityHead == 90 || vanityHead == 91))
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Titanium");
            ...
            if (vanityBody == 24 && vanityLegs == 23)
            {
                if (vanityHead == 42)
                {
                    player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.HallowCaster");
                    player.manaCost -= 0.2f;
                }
                else if (vanityHead == 43)
                {
                    player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.HallowMelee");
                    player.meleeSpeed += 0.19f;
                    player.moveSpeed += 0.19f;
                }
                else if (vanityHead == 41)
                {
                    player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.HallowRanged");
                    player.ammoCost75 = true;
                }
            }
            if (vanityHead == 82 && vanityBody == 53 && vanityLegs == 48)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Tiki");
                ++player.maxMinions;
            }
            if (vanityHead == 134 && vanityBody == 95 && vanityLegs == 79)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Spooky");
                player.minionDamage += 0.25f;
            }
            if (vanityHead == 160 && vanityBody == 168 && vanityLegs == 103)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Bee");
            ...
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Spider");
                player.minionDamage += 0.12f;
            }
            if (vanityHead == 171 && vanityBody == 177 && vanityLegs == 112)
            {
                player.solarCounter = player.GetModPlayer<ArmorSocialPlayer>().solarCounter;
                player.setSolar = true;
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Solar");
                ++player.solarCounter;
                int num = 240;
            ...
            {
                player.vortexStealthActive = player.GetModPlayer<ArmorSocialPlayer>().vortexStealthActive;
                player.setVortex = true;
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Vortex", (object) Language.GetTextValue(Main.ReversedUpDownArmorSetBonuses ? "Key.UP" : "Key.DOWN"));
            }
            if (vanityHead == 170 && vanityBody == 176 && vanityLegs == 111)
            {
                ...
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Nebula");
            }
            if (vanityHead == 189 && vanityBody == 190 && vanityLegs == 130)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Stardust", (object) Language.GetTextValue(Main.ReversedUpDownArmorSetBonuses ? "Key.UP" : "Key.DOWN"));
            ...
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.Forbidden", (object) Language.GetTextValue(Main.ReversedUpDownArmorSetBonuses ? "Key.UP" : "Key.DOWN"));
            ...
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.SquireTier2");
                player.setSquireT2 = true;
                ++player.maxTurrets;
            }
            if (vanityHead == 203 && vanityBody == 200 && vanityLegs == 144)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.ApprenticeTier2");
                player.setApprenticeT2 = true;
                ++player.maxTurrets;
            }
            if (vanityHead == 205 && vanityBody == 202 && (vanityLegs == 147 || vanityLegs == 146))
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.HuntressTier2");
                player.setHuntressT2 = true;
                ++player.maxTurrets;
            }
            if (vanityHead == 206 && vanityBody == 203 && vanityLegs == 148)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.MonkTier2");
                player.setMonkT2 = true;
                ++player.maxTurrets;
            }
            if (vanityHead == 210 && vanityBody == 204 && vanityLegs == 152)
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.SquireTier3");
            ...
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.ApprenticeTier3");
            ...
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.HuntressTier3");
            ...
            {
                player.GetModPlayer<ArmorSocialPlayer>().secondSetBonus = Language.GetTextValue("ArmorSetBonus.MonkTier3");
